/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0e1a2c891c8f95928f1c42bb8a0bbd5c)
// Runtime types generated with workerd@1.20260701.1 2026-07-02 nodejs_compat
interface __BaseEnv_Env {
	STORAGE: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: 'https://linkportal.pietieklipkop.workers.dev,https://*-linkportal.pietieklipkop.workers.dev';
	RESEND_API_KEY: 're_9yK94uEC_BQaJvdmXcW1mg38bRPuBPNT4';
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'BETTER_AUTH_URL' | 'RESEND_API_KEY' | 'BETTER_AUTH_SECRET'>
	> {}
}
